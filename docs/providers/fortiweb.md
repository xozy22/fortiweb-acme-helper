...
|---|---|---|
| Upload Intermediate-CA | `system/certificate.intermediate_ca.import_certificate` | Pfad per `endpoints.inter_cert_import` überschreiben, oder `chain_mode: fullchain` |
